...
<body id="page-top">
 ...
 <!-- Sidebar -->
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Nav Item - Dashboard -->
                <li class="nav-item">
                    <a class="nav-link" href="dashboardadmin.jsp?page=dashboard">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseCourses" class="collapse" aria-labelledby="headingCourses" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="dashboardadmin.jsp?page=course">My Courses</a>
                            <div class="collapse-divider"></div>
                            <h6 class="collapse-header">Create:</h6>
                            <a class="collapse-item" href="dashboardadmin.jsp?page=course-create">Create Course</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseQuizzes" class="collapse" aria-labelledby="headingQuizzes"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="dashboardadmin.jsp?page=quiz">My Quizzes</a>
                            <div class="collapse-divider"></div>
                            <h6 class="collapse-header">Create:</h6>
                            <a class="collapse-item" href="dashboardadmin.jsp?page=quiz-create">Create Quiz</a>
                        </div>
                    </div>
                </li>
                ...
                <!-- Nav Item - Marks -->
                <li class="nav-item">
                    <a class="nav-link" href="dashboardadmin.jsp?page=score">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseBlogs" class="collapse" aria-labelledby="headingBlogs"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="dashboardadmin.jsp?page=blog">My Blogs</a>
                            <div class="collapse-divider"></div>
                            <h6 class="collapse-header">Create:</h6>
                            <a class="collapse-item" href="dashboardadmin.jsp?page=blog-create">Create Blog</a>
                        </div>
                    </div>
                </li>
                ...
                <!-- Nav Item - Charts -->
                <li class="nav-item">
                    <a class="nav-link" href="dashboardadmin.jsp?page=rank">
                        <i class="fas fa-fw fa-trophy"></i>
                        <span>Ranking</span></a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="dashboardadmin.jsp?page=user">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                <jsp:include page="contentadmin.jsp"/>
                <!-- /.container-fluid -->
            </div>
            <!-- End of Main Content -->
