 ...
 * @author Admin
 */
@WebServlet(name = "SourceAddController", urlPatterns = {"/SourceAddController"})
public class SourceAddController extends HttpServlet {
         ...
         if (check.equals("sourceAdd")) {
            ...
            try {
                ...
                if (Title.isEmpty() || Title.length() > 250) {
                    flag = false;
                    sourceDTO.setTitle("Title must be [1-250]");
                }
                if (flag) {
                     dao = new BlogDAO();
